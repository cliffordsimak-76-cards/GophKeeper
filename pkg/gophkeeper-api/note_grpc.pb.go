...
type NoteServiceClient interface {
	...
	ListAvailableNotes(ctx context.Context, in *ListAvailableNotesRequest, opts ...grpc.CallOption) (*ListAvailableNotesResponse, error)
}
...
func (c *noteServiceClient) CreateNote(ctx context.Context, in *CreateNoteRequest, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := c.cc.Invoke(ctx, "/gophkeeper.v1.NoteService/CreateNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *noteServiceClient) UpdateNote(ctx context.Context, in *UpdateNoteRequest, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := c.cc.Invoke(ctx, "/gophkeeper.v1.NoteService/UpdateNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *noteServiceClient) GetNote(ctx context.Context, in *GetNoteRequest, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := c.cc.Invoke(ctx, "/gophkeeper.v1.NoteService/GetNote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *noteServiceClient) ListAvailableNotes(ctx context.Context, in *ListAvailableNotesRequest, opts ...grpc.CallOption) (*ListAvailableNotesResponse, error) {
	out := new(ListAvailableNotesResponse)
	err := c.cc.Invoke(ctx, "/gophkeeper.v1.NoteService/ListAvailableNotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NoteServiceServer interface {
	...
	ListAvailableNotes(context.Context, *ListAvailableNotesRequest) (*ListAvailableNotesResponse, error)
...
func (UnimplementedNoteServiceServer) ListAvailableNotes(context.Context, *ListAvailableNotesRequest) (*ListAvailableNotesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAvailableNotes not implemented")
}
...
func _NoteService_CreateNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gophkeeper.v1.NoteService/CreateNote",
	}
...
func _NoteService_UpdateNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gophkeeper.v1.NoteService/UpdateNote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NoteService_GetNote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gophkeeper.v1.NoteService/GetNote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _NoteService_ListAvailableNotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAvailableNotesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NoteServiceServer).ListAvailableNotes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gophkeeper.v1.NoteService/ListAvailableNotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NoteServiceServer).ListAvailableNotes(ctx, req.(*ListAvailableNotesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NoteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gophkeeper.v1.NoteService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListAvailableNotes",
			Handler:    _NoteService_ListAvailableNotes_Handler,
		},
	},
